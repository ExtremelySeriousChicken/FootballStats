...
# The class that will help processData function
class leagueCountry(object):
    def __init__(self, countryName, leagueName):
...
# Requires : the country list
# Modifies : The file system
# Effects  : This is the main function in this file. THis function
#            Primarily take the countryList generated by the
#            convert function above and iterate through the data
#            Then it will open the csv files one by one
#            and make different csv files of the trend.
#            The catch here is that unlike th other file generator,
#            this function group the files based on the trend
#            For example, points overtime are going to be
#            stored in results/trendv1/points/ folder
def processData(countryList):
    #iterate through the country
    for countryData in countryList:
        countryName = countryData.countryName
        for leagueData in countryList.leagues:
            leagueName = leagueData.leagueName
            openAndProcessPoints(countryName,
                                 leagueName,
                                 leagueData.seasons)
            openAndProcess
